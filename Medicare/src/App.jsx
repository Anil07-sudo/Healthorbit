...
import Service from './pages/ServiceDetailPage/Service';
import ServiceDetailPage from './components/ServicePage/ServiceDetailPage';
import ContactPage from './components/ContactPage/ContactPage';
import Contact from './pages/Contact';
import Login from './pages/Login';
import DHome from './doctor/Navbar/DHome';
import List from './doctor/ListPage/List';
import Editprofile from './doctor/EditProfilePage/Editprofile';
import Appointment from './components/AppointmentPage/Appointment';
import { CircleChevronUp } from 'lucide-react';
import Verifypaymentpage from '../Verifypaymentpage';
import VerifypaymentServicepage from '../VerifypaymentServicepage';
...
<Route
  ...
  element={<VerifypaymentServicepage />}
/>
