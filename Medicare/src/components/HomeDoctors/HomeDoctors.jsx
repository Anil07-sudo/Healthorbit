  ...
  import { homeDoctorsStyles,iconSize } from '../../dummyStyles'
import { ChevronRight, Home, MousePointer2Off,Medal } from 'lucide-react';
  ...
  <section className={homeDoctorsStyles.section}>
    <div className={homeDoctorsStyles.container}>
      ...
      (async () => {
        ...
        ) : null} {/* so here  to fetch the api to get response*/}
