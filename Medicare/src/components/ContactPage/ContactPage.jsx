...
import { contactPageStyles } from '../../dummyStyles'
import { Mail, MapPin, MessageSquare, Phone, SendHorizontal, Stethoscope, User } from 'lucide-react';
...
const ContactPage=()=> {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/9322132913?text=${encodeURIComponent(text)}`;
  ...
  <label
    htmlFor="service"
    className={contactPageStyles.label}
  >
...
{availableServices.map((s) => (
  <option key={s} value={s}>
   ...
   {errors.service && (
  <p className={contactPageStyles.service}>
    {errors.name}
  </p>
   )}
</div>
...
<div className={contactPageStyles.buttonContainer}>
  <button
    type="submit"
    className={`${contactPageStyles.button} cursor-pointer`}
  >
