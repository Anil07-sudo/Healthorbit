import React, { useRef, useState, useEffect } from "react";
  import { testimonialStyles} from '../../dummyStyles';
...
const Testimonial =() =>{
  ...
  const testimonials = [
    {
      ...
      image:
        "https://i.postimg.cc/fWpySQTq/Whats-App-Image-2025-12-31-at-17-40-12.jpg",
      type: "doctor",
    },
    {
      id: 2,
  ...
  const leftTestimonials = testimonials.filter((t) => t.type === "patient");
  const rightTestimonials = testimonials.filter((t) => t.type === "doctor");
...
>
  <div
    className={`${testimonialStyles.columnContainer}
     ${testimonialStyles.leftColumnBorder
