...
export const doctorDetailStyles = {
  ...
  // File upload styles
  fileInput: "w-40 md:w-[180px] border-2 border-emerald-100 rounded-full p-2 text-sm bg-white focus:border-emerald-400 transition cursor-pointer",
...
export const heroStyles = {
  ...
  // Info cards styles
  infoCards: {
    container: "mx-auto max-w-3xl grid grid-cols-1 sm:grid-cols-3 gap-6 mt-5",
