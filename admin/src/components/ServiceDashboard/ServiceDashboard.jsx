...
import {serviceDashboardStyles} from '../../dummyStyles';
import{User,XCircle,EyeClosed ,Calendar,Plus,Trash2,CheckCircle,Search, ClipboardList, BadgeIndianRupee} from 'lucide-react';
...
>
  ...
  />
   <StatCard
    ...
    label="Completed"
    value={totals?.totalCompleted || 0}
  />
   <StatCard
    icon={<XCircle size={18} />}
    label="Canceled"
    value={totals?.totalCanceled || 0}
  />
</div>
{/* search bar */}
