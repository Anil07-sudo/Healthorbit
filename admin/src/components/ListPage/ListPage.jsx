...
// helper function
// this function will give a date 
...
const API_BASE = "https://healthorbit-backend.onrender.com";
  ...
  // show doctors accordingly to filters
...
// delete doctors
  ...
  // show all doctor or the filtered ones
 ...
 return (
      ...
      <div className={doctorListStyles.headerTopSection}>
        <div className={doctorListStyles.headerIconContainer}>
          <div className={doctorListStyles.headerIcon}>
            <Users
              size={20}
              className={doctorListStyles.headerIconSvg}
            />
            
          </div>
          <div>
  <h1 className={doctorListStyles.headerTitle}>
    Find a Doctor
  </h1>
  ...
  <Search
    size={16}
    className={doctorListStyles.searchIcon}
  />
  ...
  <div className={doctorListStyles.doctorHeader}>
    <div className="min-w-0 w-full">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span
  className={doctorListStyles.availabilityBadge(isAvailable)}
>
  <span
    className={doctorListStyles.availabilityDot(isAvailable)}
  />
