import  {react,useState,useEffect,useMemo,useRef,serviceId}from 'react';
import { addServiceStyles } from "../../dummyStyles";
import{User,XCircle,EyeClosed ,Calendar,Plus,Trash2,CheckCircle,Search,AlertTriangle,Image,Clock} from 'lucide-react';
...
const AddService = () => {
 ...
 const fileRef = useRef(null);
  ...
  const [hasExistingImage, setHasExistingImage] = useState(false);// to update if image is found
...
>
  <XCircle className="w-4 h-4 text-gray-200 hover:text-white transition-colors" />
</button>
...
<div className={addServiceStyles.grids.main}>
  <div className="lg:col-span-1 md:col-span-1 col-span-1 flex flex-col items-center">
    ...
    <div className="mt-2 text-sm">
      Service image <span className="text-red-500">(required)</span>
    </div>
  </div>)}
      </div>
