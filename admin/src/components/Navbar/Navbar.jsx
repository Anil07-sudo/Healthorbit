...
//sliding active indicartor   
  ...
  console.warn("colud not reterive  clerk token",err);
}
...
<Link to="/">
  <div className={ns.logoLink}>HealthOrbit</div>
  <div className={ns.logoSubtext}>Hospital Network</div>
</Link>
          </div>
          {/* center navigation */}
...
{/*right side*/}
<div className={ns.rightContainer}>{/* auth */}
...
>
  {open ? <X size={18} /> : <Menu size={18} />}
        ...
        {
          open &&(<div className={ns.mobileMenuContainer} id ="mobile-menu">
